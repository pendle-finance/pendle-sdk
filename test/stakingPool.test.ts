...
import { dummyAddress, Token, TokenAmount } from '../src';
...
const PendleSingle: StakingPool = StakingPool.find(
  '0x07282f2ceebd7a65451fcd268b364300d9e6d7f5',
  '0x808507121b80c02388fad14726482e061b8da827',
  1
);
const OTPE2022Pool: StakingPool = StakingPool.find(
  '0x2c09fd74e80ce12bebbc8f56fab8633ea41c2bcc',
  '0xb124c4e18a282143d362a066736fd60d22393ef4',
  1
);
const OTcDAI2021Pool: StakingPool = StakingPool.find(
  '0x071dc669be57c1b3053f746db20cb3bf54383aea',
  '0x2c80d72af9ab0bb9d98f607c817c6f512dd647e6',
  1
);
const OTaUSDC2022Pool: StakingPool = StakingPool.find(
  '0x94a7432b811e29128964fba993f159928744e7c7',
  '0x0d8a21f2ea15269b7470c347083ee1f85e6a723b',
  1
);
const YTcDAI2021Pool: StakingPool = StakingPool.find(
  '0x5b1c59eb6872f88a92469751a034b9b5ada9a73f',
  '0x944d1727d0b656f497e74044ff589871c330334f',
  1
);
const YTcDAI2022Pool: StakingPool = StakingPool.find(
  '0x5b1c59eb6872f88a92469751a034b9b5ada9a73f',
  '0xb26c86330fc7f97533051f2f8cd0a90c2e82b5ee',
  1
);
const YTPE2022Pool: StakingPool = StakingPool.find(
  '0x0f3bccbfef1dc227f33a11d7a51cd02dead208c8',
  '0x685d32f394a5f03e78a1a0f6a91b4e2bf6f52cfe',
  1
);
const YTaUSDC2022Pool: StakingPool = StakingPool.find(
  '0x6f40a68e99645c60f14b497e75ae024777d61726',
  '0x8315bcbc2c5c1ef09b71731ab3827b0808a2d6bd',
  1
);
const YTaUSDC2021Pool: StakingPool = StakingPool.find(
  '0x6f40a68e99645c60f14b497e75ae024777d61726',
...
describe('Staking pools', () => {
  ...
  it.skip('stake', async () => {
    const res = await sp
      ...
      .stake(new TokenAmount(new Token('0x685d32f394a5f03e78a1a0f6a91b4e2bf6f52cfe', 18), '1000'));
