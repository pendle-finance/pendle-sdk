...
describe('Redeem Proxy', () => {
  ...
  it('redeemLmV2Interests', async () => {
    ...
    const res = await RedeemProxy.methods({ signer, provider, chainId }).callStatic.redeemLmV2Interests(
      lmAddresses,
      dummyAddress
    );
  ...
  it('redeemTokenDist', async () => {
    const res = await RedeemProxy.methods({ signer, provider, chainId }).callStatic.redeemTokenDist(
      ['0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7', '0x8729438eb15e2c8b576fcc6aecda6a148776c0f5'],
