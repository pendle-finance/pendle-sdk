...
const PendleLiquidityMiningBaseV2Multi = require('../abis/PendleLiquidityMiningBaseV2Multi.json');
...
const PendleLiquidityRewardsReaderMulti = require('../abis/PendleLiquidityRewardsReaderMulti.json');
